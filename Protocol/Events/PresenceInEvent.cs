...
{
    internal class PresenceInEvent : EventBase
    {
        ...
        public string alt_event_type { get; set; }

        [JsonProperty("presence-call-info-state")]
        public string presencecallinfostate { get; set; }

        [JsonProperty("presence-call-direction")]
        public string presencecalldirection { get; set; }
        public string event_count { get; set; }

        [JsonProperty("Presence-Calling-File")]
        public string PresenceCallingFile { get; set; }

        [JsonProperty("Presence-Calling-Function")]
        public string PresenceCallingFunction { get; set; }

        [JsonProperty("Presence-Calling-Line")]
        public string PresenceCallingLine { get; set; }
    }
}
